    ...
    <div className="container mx-auto p-4 bg-gray-100 rounded-md">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
        <div className="flex flex-col items-center border-r border-gray-300 pr-4">
          <div className="text-2xl mb-4 text-sky-500 bg-sky-100 p-1 rounded-lg">
            <HiOutlineUserGroup />
          </div>
        ...
        <div className="flex flex-col items-center border-r border-gray-300 pr-4">
          <div className="text-2xl mb-4 text-red-600 bg-red-100 p-1 rounded-lg">
            <AiOutlineUsergroupDelete />
          </div>
          <div className="flex text-center items-center space-x-6">
        ...
        <div className="flex flex-col items-center border-r border-gray-300 pr-4">
          <div className="text-2xl mb-4 text-green-500 bg-green-100 p-1 rounded-lg">
            <AiOutlineUsergroupAdd />
          </div>
          <div className="flex text-center items-center space-x-6">
            <div className="text-lg font-medium">{partners.length}</div>
            <div className="text-sm text-gray-500">Partners</div>
          </div>
        </div>
        <div className="flex flex-col items-center">
          <div className="text-2xl mb-4 text-orange-500 bg-orange-100 p-1 rounded-lg">
            <VscFeedback />
          </div>
          <div className="flex text-center items-center space-x-6">
